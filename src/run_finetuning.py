...
def main():
    ...
    dataset_names = [dataset_name.strip() for dataset_name in data_args.dataset_name.split(",")]
    ...
    for i, dataset_name in enumerate(dataset_names):
        ...
        if i == 0:
            ...
            train_dataset = datasets.concatenate_datasets([train_dataset, dataset["train"]])
            eval_dataset = datasets.concatenate_datasets([eval_dataset, dataset["test"]])
    ...
    def remove_special_characters(batch):
        ...
        batch["text"] = batch["text"].replace('è', 'é')
        batch["text"] = batch["text"].replace("\u00e1", 'a')
